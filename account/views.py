    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if user:
                ...
                messages.warning(self.request, 'Your Message is Wrong !')
...
class ChangePassword(LoginRequiredMixin, generic.FormView):
    ...
    def form_valid(self, form):
        ...
        user.set_password(form.cleaned_data.get('new-password1'))
        user.save()
        messages.success(self.request, "Password Changed  Successfull !")
        return super().form_valid(form)
